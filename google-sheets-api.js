...
async function initializeGapiClient() {
  try {
    await gapi.client.init({
      clientId: '715063492691-g4okpefanrian3pp3q13i1gdo3kfcnrc.apps.googleusercontent.com',
      clientSecret: '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',
      apiKey: 'AIzaSyDFoGFhvd8U79mNj9myx7G6r2OcfVWYq2Q',
      discoveryDocs: ['https://sheets.googleapis.com/$discovery/rest?version=v4'],
      scope: 'https://www.googleapis.com/auth/spreadsheets'
    })
